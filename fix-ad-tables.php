...
mysqli_query($conn, "DROP TABLE IF EXISTS ad_clicks");
mysqli_query($conn, "DROP TABLE IF EXISTS ad_impressions"); 
mysqli_query($conn, "DROP TABLE IF EXISTS advertisements");

// Create advertisements table with correct structure
...
$sql = "CREATE TABLE ad_impressions (
    id INT AUTO_INCREMENT PRIMARY KEY,
    ad_id INT NOT NULL,
...
echo "<a href='admin/manage-ads.php'>Go to Ad Management</a><br>";
echo "<a href='ad-integration-example.php'>View Integration Example</a>";
?>
