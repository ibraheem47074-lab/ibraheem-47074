...
$page_title = 'Edit Affiliate Product';
$success_message = '';
$error_message = '';
...
if ($product_id === 0) {
    header('Location: manage-affiliate-products.php');
    exit();
}

// Get product details
$product_query = "SELECT * FROM affiliate_products WHERE id = ?";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($affiliate_url)) {
        ...
        $check_slug = "SELECT id FROM affiliate_products WHERE slug = ? AND id != ?";
        $stmt = mysqli_prepare($conn, $check_slug);
        mysqli_stmt_bind_param($stmt, 'si', $slug, $product_id);
        mysqli_stmt_execute($stmt);
        ...
        // Update product
        $update_query = "UPDATE affiliate_products SET 
        ...
        mysqli_stmt_bind_param($stmt, "sssddsssssiissssissi", 
            $title, $slug, $description, $short_description, $price, $original_price,
            $currency, $image_url, $affiliate_url, $affiliate_network, $category_id,
            $rating, $review_count, $availability, $brand, $model, $tags, $featured, $status, $product_id
        );
        
        if (mysqli_stmt_execute($stmt)) {
            $success_message = "Product updated successfully! <a href='manage-affiliate-products.php'>Manage Products</a>";
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-shopping-cart"></i> Edit Affiliate Product
                    </h3>
                    <div class="card-tools">
                        <a href="manage-affiliate-products.php" class="btn btn-secondary btn-sm">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="price" name="price" 
                                                   step="0.01" min="0" value="<?php echo htmlspecialchars($product['price']); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="original_price" name="original_price" 
                                                   step="0.01" min="0" value="<?php echo htmlspecialchars($product['original_price']); ?>">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="currency" name="currency">
                                                ...
                                                <option value="GBP" <?php echo ($product['currency'] === 'GBP') ? 'selected' : ''; ?>>GBP (£)</option>
                                                <option value="PKR" <?php echo ($product['currency'] === 'PKR') ? 'selected' : ''; ?>>PKR (₨)</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control" id="affiliate_url" name="affiliate_url" 
                                           value="<?php echo htmlspecialchars($product['affiliate_url']); ?>" required
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="affiliate_network" name="affiliate_network">
                                                <option value="amazon" <?php echo ($product['affiliate_network'] === 'amazon') ? 'selected' : ''; ?>>Amazon</option>
                                                <option value="aliexpress" <?php echo ($product['affiliate_network'] === 'aliexpress') ? 'selected' : ''; ?>>AliExpress</option>
                                                <option value="other" <?php echo ($product['affiliate_network'] === 'other') ? 'selected' : ''; ?>>Other</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="availability" name="availability">
                                                ...
                                                <option value="limited" <?php echo ($product['availability'] === 'limited') ? 'selected' : ''; ?>>Limited Stock</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if (!empty($product['image_url'])): ?>
                                        <img src="<?php echo htmlspecialchars($product['image_url']); ?>" 
                                             alt="Current image" style="max-width: 100%; height: 150px; object-fit: cover; margin-top: 10px;">
                                    <?php endif; ?>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="rating" name="rating" 
                                                   step="0.1" min="0" max="5" value="<?php echo htmlspecialchars($product['rating']); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="review_count" name="review_count" 
                                                   min="0" value="<?php echo htmlspecialchars($product['review_count']); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="alert alert-info">
                                    ...
                                    Clicks: <?php echo number_format($product['click_count']); ?><br>
                                    Conversions: <?php echo number_format($product['conversion_count']); ?><br>
                                    Created: <?php echo format_date($product['created_at']); ?>
                                </div>
