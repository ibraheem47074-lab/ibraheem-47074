...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['upload_avatar']) && isset($_FILES['avatar'])) {
        ...
        // Debug information
        $debug_info = "Upload Error: " . $avatar['error'] . " - " . $avatar['name'];
        
        // Validate file
        if ($avatar['error'] !== UPLOAD_ERR_OK) {
            $error = "Upload error: " . $avatar['error'] . " - " . $debug_info;
            ...
            $error = "File size must be less than 5MB! Current size: " . $avatar['size'] . " bytes";
        } else {
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <div class="card-body text-center">
                        <img src="<?php echo !empty($user['avatar']) ? '../uploads/avatars/' . htmlspecialchars($user['avatar']) : 'https://ui-avatars.com/api/?name=' . urlencode($user['name']) . '&size=120&background=4834d4&color=fff'; ?>" 
                        ...
                        <div class="mt-3">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div id="avatarPreview" class="mb-2"></div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-2 mb-2">
                                <a href="editor-dashboard-enhanced.php" class="btn btn-primary btn-sm w-100">
