...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title . ' - ' : ''; ?>PK Live News Editor</title>
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="editor-profile-new.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2"><?php echo isset($page_title) ? $page_title : 'Editor Dashboard'; ?></h1>
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group me-2">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="editor-profile-new.php"><i class="fas fa-user me-2"></i>Profile</a></li>
