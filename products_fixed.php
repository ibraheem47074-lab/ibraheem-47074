...
// Only build where clause if tables exist
$where_clause = $affiliate_tables_exist ? 'WHERE ' . implode(' AND ', $where_conditions) : '';
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="product-categories mb-4">
                <a href="products_fixed.php" class="category-pill <?php echo empty($category_id) ? 'active' : ''; ?>">
                    All Products
                </a>
                <?php foreach ($categories as $category): ?>
                    <a href="products_fixed.php?category=<?php echo $category['id']; ?>" 
                    ...
                    <nav aria-label="Products pagination" class="mt-5">
                        <div class="d-flex justify-content-center">
                            <ul class="pagination">
                                ...
                                if ($start_page > 1) {
                                    echo '<li class="page-item"><a class="page-link" href="?page=1&search=' . urlencode($search) . '&category=' . $category_id . '&sort=' . $sort . '&min_price=' . $min_price . '&max_price=' . $max_price . '">1</a></li>';
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    ...
                    <a href="products_fixed.php" class="btn btn-primary">Clear Filters</a>
                </div>
            <?php endif; ?>
        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="list-group list-group-flush">
                            <a href="products_fixed.php" class="list-group-item list-group-item-action <?php echo empty($category_id) ? 'active' : ''; ?>">
                                All Products
                            </a>
                            <?php foreach ($categories as $category): ?>
                                <a href="products_fixed.php?category=<?php echo $category['id']; ?>" 
