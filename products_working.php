        ...
        <div class="col-lg-9">
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    ...
                    <a href="products_working.php" class="btn btn-primary">Clear Filters</a>
                </div>
            <?php endif; ?>
        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="list-group list-group-flush">
                            <a href="products_working.php" class="list-group-item list-group-item-action <?php echo empty($category_id) ? 'active' : ''; ?>">
                                All Products
                            </a>
                            <?php foreach ($categories as $category): ?>
                                <a href="products_working.php?category=<?php echo $category['id']; ?>" 
